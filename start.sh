...
PORT="${PORT:-4610}"
DB_NAME="${PGDATABASE:-quality_safety_compliance_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Quality Safety Compliance Suite"
echo "======================================="
echo
...
echo "Starting quality safety compliance suite frontend on http://localhost:$PORT"
echo "Login: admin@quality-safety.local / admin123"
