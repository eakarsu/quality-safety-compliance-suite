...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Quality Safety Compliance Dashboard"
      subtitle="One merged quality safety compliance view for Incidents, Audits, CAPA, Inspections, Training, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared quality safety compliance jobs into one surface. Incidents, Audits, CAPA, Inspections, Training, Policies, documents, audit, and AI are presented as platform features.</div>
