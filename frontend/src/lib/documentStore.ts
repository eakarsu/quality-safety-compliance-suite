...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Incidents Packet', type: 'Incidents', owner: 'Quality Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Audits Review Bundle', type: 'Audits', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'CAPA Evidence Set', type: 'CAPA', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
