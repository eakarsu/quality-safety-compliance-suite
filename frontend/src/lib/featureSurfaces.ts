...
const featureSeeds = [
  ['incidents', 'Incidents', 'Incidents operating queue', 'Quality Lead', 'Review and assign next action'],
  ['audits', 'Audits', 'Audits operating queue', 'Quality Lead', 'Review and assign next action'],
  ['capa', 'CAPA', 'CAPA operating queue', 'Quality Lead', 'Review and assign next action'],
  ['inspections', 'Inspections', 'Inspections operating queue', 'Quality Lead', 'Review and assign next action'],
  ['training', 'Training', 'Training operating queue', 'Operations Lead', 'Review and assign next action'],
  ['policies', 'Policies', 'Policies operating queue', 'Operations Lead', 'Review and assign next action'],
  ['controls', 'Controls', 'Controls operating queue', 'Operations Lead', 'Review and assign next action'],
  ['findings', 'Findings', 'Findings operating queue', 'Operations Lead', 'Review and assign next action'],
  ['corrective-actions', 'Corrective Actions', 'Corrective Actions operating queue', 'Governance Lead', 'Review and assign next action'],
  ['certifications', 'Certifications', 'Certifications operating queue', 'Governance Lead', 'Review and assign next action'],
  ['risk-register', 'Risk Register', 'Risk Register operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
