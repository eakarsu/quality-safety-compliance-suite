export const AUTH_COOKIE = 'quality_safety_compliance_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@quality-safety.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@quality-safety.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@quality-safety.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
